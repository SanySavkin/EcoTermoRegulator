...
typedef char md5_string_t[MD5_CSTR_BUF_LEN];

extern void MD5Init (md5_context_t *);
extern void MD5Update (md5_context_t *, const uint8_t *, const uint16_t);
extern void MD5Final (uint8_t [MD5_HASH_SIZE], md5_context_t *);

extern char * Md5ToCString(uint8_t _md5[MD5_HASH_SIZE], md5_string_t _out);
